...
const Stepper = () => {
  return (
    <ol className="flex items-center h-10 w-full my-4 px-4 font-medium text-center text-gray-500 text-lg bg-slate-200 rounded-xl shadow-md">
        <li className="flex md:w-full items-center text-blue-600 dark:text-blue-500 px-2">
        ...
        <li className='hidden md:block md:flex-auto md:border-b-2 md:border-gray-400 md:mt-1 transition duration-500 ease-in-out md:px-4'  />
        <li className='md:hidden'>/</li>

        <li className="flex md:w-full items-center px-2">
            <span className="flex items-center">
        ...
        <li className="flex items-center px-2 text-green-800">
            Results
        </li>
    </ol>
